...
import VerticalCarouselText from '@/components/ui/VerticalCarouselText';
...
export default function LandingPageDummy({ onStart, showBlob = true }: LandingPageProps) {
  ...
  useEffect(() => {
    // Mock data directly
    setConversationCount(123); // Dummy count
